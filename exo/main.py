...
parser.add_argument("--chatgpt-api-response-timeout", type=int, default=99999, help="ChatGPT API response timeout in seconds")
parser.add_argument("--max-generate-tokens", type=int, default=50000, help="Max tokens to generate in each request")
